...
In this section, we present two heuristic approaches, namely {\it MinHash Clustering (MC)} and {\it Estimated MinHash Clustering (EMC)}, to construct \DBIndex . The first approach $MC$ is to construct

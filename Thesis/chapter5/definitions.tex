...
\end{definition}
There are four parameters in our general co-movement pattern, including object constraint $M$ and temporal constraints $K,L,G$. \revised{These parameters have different effects on the number of patterns discovered. Larger $K$, $L$, $M$ 

...
%    \end{subfigure}
%\caption{Performance of SPARE and TRPM on Shopping dataset.}
%	\label{exp:performance_shopping_vary}
%\end{figure}
%
%\begin{figure}[h]
%\centering
...
%    \end{subfigure}  
%\caption{Performance of SPARE and TRPM on GeoLife dataset.}
%	\label{exp:performance_geolife_vary}
%\end{figure}
%
%\begin{figure}[h]
%\centering
...
%    \end{subfigure}
%	 \caption{Performance of SPARE and TRPM on Taxi dataset.}
%	\label{exp:performance_taxi_vary}
%\end{figure}  
...
\begin{figure}[h]
\centering
\includegraphics[width=0.7\textwidth]{chapter5/exp/spare/detail1.eps}
